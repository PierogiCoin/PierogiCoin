        ...
        <main className="min-h-screen bg-black text-white pt-24 pb-20 px-4 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto space-y-12">
                ...
                <div className="text-center space-y-4">
                    ...
                    >
                        Wybierz metodę wyceny, która najbardziej Ci odpowiada. Skorzystaj z tradycyjnego kalkulatora lub pozwól sztucznej inteligencji dobrać rozwiązanie dla Ciebie.
                    </motion.p>
                </div>
                ...
                <div className="flex justify-center">
                    <div className="bg-white/5 p-1 rounded-full border border-white/10 flex relative">
                        <button
                            ...
                            className={`relative z-10 px-6 py-2 rounded-full text-sm font-medium transition-colors flex items-center gap-2 ${mode === "standard" ? "text-white" : "text-gray-400 hover:text-white"
                                }`}
                        >
                        ...
                        <button
                            onClick={() => setMode("ai")}
                            className={`relative z-10 px-6 py-2 rounded-full text-sm font-medium transition-colors flex items-center gap-2 ${mode === "ai" ? "text-white" : "text-gray-400 hover:text-white"
                                }`}
                        >
