  ...
  const SERVICES = [
    {
      ...
      description: dict.services.items.design.desc,
      icon: PenTool,
    ...
    {
      id: 'dev',
      title: dict.services.items.dev.title,
      description: dict.services.items.dev.desc,
      icon: Monitor,
      color: "text-cyan-400",
    ...
    },
    {
      ...
      description: dict.services.items.mobile.desc,
      icon: Smartphone,
      color: "text-pink-400",
    ...
    {
      id: 'seo',
      title: dict.services.items.seo.title,
      description: dict.services.items.seo.desc,
      icon: Search,
    ...
    {
      id: 'conversion',
      title: dict.services.items.conversion.title,
      description: dict.services.items.conversion.desc,
      icon: Handshake,
    ...
    {
      id: 'speed',
      title: dict.services.items.speed.title,
      description: dict.services.items.speed.desc,
      icon: Zap,
      color: "text-blue-400",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-5xl font-bold text-slate-900 dark:text-white mb-4">
            {dict.services.title} <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-500">{dict.services.title_highlight}</span>
          </h2>
