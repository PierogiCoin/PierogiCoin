            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="pricing-header text-center mb-16">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cyan-500/10 border border-cyan-500/20 text-cyan-600 dark:text-cyan-400 text-sm font-bold mb-6">
                        <Sparkles size={16} />
                        <span>Transparentne Zasady</span>
                    </div>
                    
                    <h2 className="text-3xl sm:text-5xl font-bold text-slate-900 dark:text-white mb-6">
                        Ty decydujesz o <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-blue-600">budżecie.</span>
                    </h2>
                    
                    <p className="text-slate-600 dark:text-gray-400 text-lg max-w-2xl mx-auto leading-relaxed">
                        Koniec z &quot;widełkami cenowymi&quot; i ukrytymi kosztami. Skorzystaj z konfiguratora, 
                        aby otrzymać precyzyjną wycenę dopasowaną do Twoich potrzeb.
                    </p>
                    ...
                    <div className="mt-8 flex flex-wrap justify-center gap-4 sm:gap-8 text-sm text-slate-500 dark:text-gray-500">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-slate-700 dark:text-gray-400">Gwarancja stałej ceny</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <ShieldCheck className="text-green-600 dark:text-green-500 w-5 h-5" />
                            <span className="text-slate-700 dark:text-gray-400">Faktura VAT 23%</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <ShieldCheck className="text-green-600 dark:text-green-500 w-5 h-5" />
                            <span className="text-slate-700 dark:text-gray-400">Płatność w transzach</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <ShieldCheck className="text-green-600 dark:text-green-500 w-5 h-5" />
                            <span className="font-semibold text-green-600 dark:text-green-400">Raty 0%</span>
                        </div>
                    </div>
                </div>
