                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-6 mt-8">
                            {/* TELEFON - Główny CTA */}
                            <a href={`tel:${siteConfig.contact.phone}`} className="contact-item group flex items-center gap-6 p-6 rounded-2xl bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 hover:border-cyan-500/50 hover:bg-cyan-50 dark:hover:bg-cyan-500/10 transition-all duration-300">
                                ...
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-slate-900 dark:text-white group-hover:text-cyan-600 dark:group-hover:text-cyan-300 transition-colors">{siteConfig.contact.displayPhone}</p>
                                </div>
                            </a>

                            {/* EMAIL */}
                            <a href={`mailto:${siteConfig.contact.email}`} className="contact-item group flex items-center gap-6 p-6 rounded-2xl bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 hover:border-purple-500/50 hover:bg-purple-50 dark:hover:bg-purple-500/10 transition-all duration-300">
                                ...
                                <div>
                                    ...
                                    <p className="text-xl font-bold text-slate-900 dark:text-white group-hover:text-purple-600 dark:group-hover:text-purple-300 transition-colors">{siteConfig.contact.email}</p>
                                </div>
                            </a>
                        </div>
