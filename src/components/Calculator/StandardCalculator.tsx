            ...
            <CardContent className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  ${selectedTech === tech.id
                            ...
                            >
                                <tech.icon className={`w-6 h-6 ${selectedTech === tech.id ? "text-purple-400" : "text-gray-400"}`} />
                ...
                <div className="space-y-3 pt-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {FEATURES.map((feature) => (
                            <div key={feature.id} className="flex items-center space-x-3 p-3 rounded-md border border-white/5 bg-black/20 hover:bg-black/30 transition-colors">
                                <Checkbox
                                    id={feature.id}
                    ...
                    {showContactForm && (
                        ...
                        >
                            <div className="bg-purple-900/20 p-4 rounded-lg border border-purple-500/30 space-y-4 mt-4">
                                ...
                                <Button className="w-full bg-purple-600 hover:bg-purple-700">Wyślij zgłoszenie</Button>
                            </div>
                        </motion.div>
                    )}
                </AnimatePresence>
            ...
            <CardFooter className="flex flex-col sm:flex-row justify-between items-center border-t border-white/10 pt-6 gap-4">
                ...
                {!showContactForm && (
                    <Button
                        ...
                        className={`w-full sm:w-auto text-white border-0 ${selectedTech === "nextjs"
