...
const AiCalculator = lazy(() => import('./AiCalculator'));
...
const CalculatorLoader = () => (
    <div className="flex flex-col justify-center items-center min-h-[600px] w-full bg-slate-50 dark:bg-white/5 rounded-3xl border border-slate-200 dark:border-white/10 backdrop-blur-sm">
        ...
        <p className="mt-6 text-cyan-600 dark:text-cyan-400 font-mono text-sm animate-pulse tracking-widest uppercase">Ładowanie kalkulatora...</p>
    </div>
);
    ...
    return (
        <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
                <h3 className="text-3xl sm:text-4xl font-bold text-slate-900 dark:text-white mb-4">Wybierz sposób wyceny projektu</h3>
                <p className="text-slate-600 dark:text-gray-400 text-lg">Dopasuj kalkulator do swoich potrzeb</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        {/* Tytuł */}
                        <h4 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">Prosty Kalkulator</h4>

                        {/* Opis */}
                        <p className="text-slate-600 dark:text-gray-400 mb-6 leading-relaxed">
                            Wybierasz opcje z listy, dostajesz natychmiastową wycenę. Idealny dla jasno określonych projektów.
                        </p>
                ...
                >
                    {/* Premium badge */}
                    <div className="absolute -top-3 -right-3 px-4 py-1 bg-gradient-to-r from-cyan-500 to-blue-600 text-white text-xs font-black rounded-full shadow-lg">PREMIUM</div>
                    ...
                    <div className="relative z-10">
                        ...
                        {/* Tytuł */}
                        <h4 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">Kalkulator AI</h4>

                        {/* Opis */}
                        <p className="text-slate-600 dark:text-gray-400 mb-6 leading-relaxed">
                            Opisujesz projekt, AI analizuje i daje szczegółową wycenę z rekomendacjami. Dla większych projektów.
                        </p>
            ...
            <div className="mt-12 flex flex-col items-center gap-6">
                ...
                <p className="text-slate-500 dark:text-gray-500 text-sm">🔒 Bezpiecznie • Bez zobowiązań • Wynik natychmiast na email</p>
            </div>
        </div>
    );
}
